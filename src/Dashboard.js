...
export default class Dashboard extends Component {
  ...
  getProduct = () => {
    ...
    axios.get(`https://back-sayna.herokuapp.com/get-product${data}`, {
      headers: {
  ...
  deleteProduct = (id) => {
    axios.post('https://back-sayna.herokuapp.com/delete-product', {
      id: id
    }, {
      headers: {
  ...
  addProduct = () => {
    ...
    axios.post('https://back-sayna.herokuapp.com/add-product', file, {
      headers: {
  ...
  updateProduct = () => {
    ...
    axios.post('https://back-sayna.herokuapp.com/update-product', file, {
      headers: {
        'content-type': 'multipart/form-data',
        'token': this.state.token
      }
            ...
            <TableBody>
              {this.state.products.map((row) => (
                <TableRow key={row.name}>
                  ...
                  <TableCell align="center"><img src={`https://back-sayna.herokuapp.com/${row.image}`} width="70" height="70" /></TableCell>
